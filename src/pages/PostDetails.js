                ...
                <div className="post-details-container">
                    <div className="post-header">
                        ...
                        <div className="post-header-options">
                            <Button onMouseEnter={onHover} onMouseLeave={onHoverLeave} onClick={onFollow} className={ ` ${following ? 'hover:bg-red-500 hover:bg-opacity-40 hover:text-red-600' : ''} btn btn-small btn-outline-black`}>
                    ...
                    <div className="post-action-buttons">
                        <BaseIcon><img src={like} alt="like"/></BaseIcon>
                        <BaseIcon><img src={save} alt="like"/></BaseIcon>
                        <BaseIcon><img src={share} alt="like"/></BaseIcon>
                    </div>
